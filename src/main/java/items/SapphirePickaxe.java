...
public class SapphirePickaxe extends ItemTool {
	...
	public SapphirePickaxe(int id, EnumToolMaterial material) {
		super(id, 9F, material, blocks);
		setUnlocalizedName(DataInfo.sapphirePick_uname);
