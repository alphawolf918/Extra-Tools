...
public class QuartzPickaxe extends ItemTool {
	...
	public QuartzPickaxe(int id, EnumToolMaterial material) {
		super(id, 5F, material, blocks);
		setUnlocalizedName(DataInfo.quartzPick_uname);
