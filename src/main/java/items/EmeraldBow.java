...
public class EmeraldBow extends Item {
	...
	public EmeraldBow(int par1) {
		super(par1);
		this.maxStackSize = 1;
		this.setMaxDamage(884);
		this.setUnlocalizedName("emeraldbow");
	...
	public void registerIcons(IconRegister par1IconRegister) {
		this.itemIcon = par1IconRegister.registerIcon("awet:emeraldbow_standby");
		this.iconArray = new Icon[bowPullIconNameArray.length];

		for (int i = 0; i < this.iconArray.length; ++i) {
			this.iconArray[i] = par1IconRegister.registerIcon("awet:emeraldbow_"
